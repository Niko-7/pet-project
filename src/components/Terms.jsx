const Terms = () => {
  return (
    <div className="terms__container">
      ...
      on the Website or otherwise when you contact us. The personal information
      that we collect depends on the context of your interactions with us and
      the Website, the choices you make and the products and features you use.
      The personal information we collect may include the following: Personal
      Information Provided by You. We may collect names; phone numbers; email
      addresses; mailing addresses; job titles; contact preferences; data
      collected from surveys; usernames; passwords; contact or authentication
      data; information you provide when using our products (e.g., business
      name, business email, business address, business fax, company website,
      etc.); number of unique views and total number of visitors when you deploy
      your cookie banner using our consent management solution; information in
      blog comments; financial information (e.g., last four digits of your debit
      or credit card number, billing history, billing address, card type,
      issuing bank, expiration date, card origin by country); profile photo; and
      other similar information. Payment Data. We may collect data necessary to
      ...
      Stripe. You may find their privacy notice link here. Social Media Login
      ...
      changes to such personal information. Information automatically collected
      ...
      when you visit, use or navigate the Website. This information does not
      reveal your specific identity (like your name or contact information) but
      may include device and usage information, such as your IP address, browser
      ...
      when you use our Website and other technical information. This information
      ...
      technologies. You can find out more about this in our Cookie Notice. The
      information we collect automatically includes: Log and Usage Data. Log and
      ...
      Website and which we record in log files. Depending on how you interact
      ...
      Website (such as the date/time stamps associated with your usage, pages
      ...
      configuration information. Location Data. We collect location data such as
      ...
      settings of the device you use to access the Website. For example, we may
      ...
      aspects of the Services. Information collected from other sources In
      Short: We may collect limited data from public databases, marketing
      partners, social media platforms, and other outside sources. In order to
      enhance our ability to provide relevant marketing, offers and services to
      ...
      programs, data providers, social media platforms, as well as from other
      ...
      depends on your social media account’s privacy settings. 2. HOW DO WE USE
      YOUR INFORMATION? In Short: We process your information for purposes based
      ...
      personal information collected via our Website for a variety of business
      ...
      information we collect or receive: To facilitate account creation and
      logon process. If you choose to link your account with us to a third-party
      ...
      creation and logon process for the performance of the contract. To manage
      user accounts. We may use your information for the purposes of managing
      our account and keeping it in working order. To request feedback. We may
      use your information to request feedback and to contact you about your use
      of our Services. To post testimonials. We post testimonials on our Website
      ...
      contact us at support@termly.io and be sure to include your name,
      testimonial location, and contact information. To protect our Services. We
      may use your information as part of our efforts to keep our Services safe
      and secure (for example, for fraud monitoring and prevention). To enforce
      our terms, conditions and policies for business purposes, to comply with
      legal and regulatory requirements or in connection with our contract. To
      ...
      how to respond. To fulfill and manage your orders. We may use your
      information to fulfill and manage your orders, payments, upgrades, or
      refunds made through the Website or otherwise through our Services. To
      deliver and facilitate delivery of services to the user. We may use your
      ...
      use of our Services. To administer prize draws and competitions. We may
      use your information to administer prize draws and competitions when you
      elect to participate in our competitions. To send you marketing and
      ...
      our Services, subscribing to marketing or otherwise contacting us, we will
      collect personal information from you. You can opt-out of our marketing
      emails at any time (see the “WHAT ARE YOUR PRIVACY RIGHTS?” below). To
      ...
      measure its effectiveness. For more information see our Cookie Notice. For
      other business purposes. We may use your information for other business
      ...
      Website, Services, products, marketing and your experience. We may use and
      ...
      your consent. 3. WILL YOUR INFORMATION BE SHARED WITH ANYONE? In Short: We
      only share information with your consent, to comply with laws, to provide
      you with services, to protect your rights, or to fulfill business
      ...
      online activity. Unless described in this notice, we do not share, sell,
      ...
      which are designed to help safeguard your personal information. This means
      ...
      we instruct. Affiliates. We may share your information with our
      ...
      that are under common control with us. Business Partners. We may share
      your information with our business partners to offer you certain products,
      services or promotions. 4. WHO WILL YOUR INFORMATION BE SHARED WITH? In
      Short: We only share information with the following categories of third
      parties. We only share and disclose your information with the following
      categories of third parties. If we have processed your data based on your
      consent and you wish to revoke your consent, please contact us using the
      contact details provided in the section below titled “HOW CAN YOU CONTACT
      US ABOUT THIS NOTICE?“. Ad Networks Affiliate Marketing Programs Cloud
      Computing Services Communication & Collaboration Tools Data Analytics
      Services Data Storage Service Providers Finance & Accounting Tools Order
      Fulfillment Service Provider Payment Processors Performance Monitoring
      Tools Product Engineering & Design Tools Retargeting Platforms Sales &
      Marketing Tools Social Networks Testing Tools User Account Registration &
      Authentication Services Website Hosting Service Providers 5. DO WE USE
      COOKIES AND OTHER TRACKING TECHNOLOGIES? In Short: We may use cookies and
      other tracking technologies to collect and store your information. We may
      use cookies and similar tracking technologies (like web beacons and
      ...
      our Cookie Notice. 6. HOW DO WE HANDLE YOUR SOCIAL LOGINS? In Short: If
      you choose to register or log in to our services using a social media
      account, we may have access to certain information about you. Our Website
      offers you the ability to register and login using your third-party social
      ...
      and apps. 7. IS YOUR INFORMATION TRANSFERRED INTERNATIONALLY? In Short:We
      may transfer, store, and process your information in countries other than
      your own. We are based in the United States and our servers are located in
      the United States. In order to provide our Services to you, please be
      aware that your information may be transferred to, stored, and processed
      by us in our facilities and by those third parties with whom we may share
      your personal information (see “WILL YOUR INFORMATION BE SHARED WITH
      ANYONE?” above), in the United Kingdom, United States, Taiwan, and other
      countries. If you are located in the European Economic Area (EEA) or
      ...
      country. With that in mind, we use appropriate safeguards when we transfer
      your information outside the EEA or UK to ensure your personal information
      remains protected and to comply with applicable data protection laws. The
      bases, mechanisms, and measures we rely on include: Adequacy Decisions.
      When applicable, we may rely on EU or UK adequacy decisions to transfer
      your information outside the EEA or UK. When the relevant EU or UK
      authority issues an adequacy decision, that means they found the third
      country to offer adequate protection for personal information.
      Derogations. We may transfer information based on a derogation listed in
      Article 49 of the GDPR. We will only do so if the transfer of information
      meets specific strict conditions. Standard Contractual Clauses: We have
      implemented measures to protect your personal information, including by
      using Standard Contractual Clauses for transfers of personal information
      between us and our group companies and between us and our third-party
      providers. These clauses require all recipients to protect all personal
      information that they process originating from the EEA or UK in accordance
      ...
      further details can be provided upon request. Supplementary Measures. When
      necessary, in addition to the Standard Contractual Clauses, we may adopt
      technical, contractual, and organizational supplementary measures to
      better ensure that the level of protection guaranteed by the GDPR is not
      undermined by the transfer. 8. HOW LONG DO WE KEEP YOUR INFORMATION? In
      ...
      your personal information for longer than three (3) months past the
      termination of the user’s account. When we have no ongoing legitimate
      ...
      any further processing until deletion is possible. 9. HOW DO WE KEEP YOUR
      ...
      access the Website within a secure environment. 10. DO WE COLLECT
      ...
      Website, you represent that you are at least 18 or that you are the parent
      or guardian of such a minor and consent to such minor dependent’s use of
      the Website. If we learn that personal information from users less than 18
      ...
      please contact us at privacy@termly.io. 11. WHAT ARE YOUR PRIVACY RIGHTS?
      ...
      terminate your account at any time. In some regions (like the EEA and UK),
      ...
      data portability. In certain circumstances, you may also have the right to
      ...
      grounds other than consent. If you are located in the EEA or UK and you
      ...
      authority. You can find their contact details here. If you are located in
      Switzerland, the contact details for the data protection authorities are
      available here. If you have questions or comments about your privacy
      rights, you may email us at privacy@termly.io. Account Information If you
      would at any time like to review or change the information in your account
      or terminate your account, you can: Contact us using the contact
      information provided. Log in to your account settings and update your user
      account. Upon your request to terminate your account, we will deactivate
      or delete your account and information from our active databases. However,
      ...
      this could affect certain features or services of our Website. To opt-out
      of interest-based advertising by advertisers on our Website, click here.
      For further information, please see our Cookie Notice. Opting out of email
      ...
      may: Contact us using the contact information provided. Access your
      account settings and update your preferences. Use the unsubscribe link at
      the bottom of any marketing emails, newsletters, or other non-essential
      communications. 12. CONTROLS FOR DO-NOT-TRACK FEATURES Most web browsers
      ...
      privacy notice. 13. DO CALIFORNIA RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?
      ...
      comprehensively removed from all our systems (e.g. backups, etc.). 14. DO
      WE MAKE UPDATES TO THIS NOTICE? In Short: Yes, we will update this notice
      as necessary to stay compliant with relevant laws. We may update this
      privacy notice from time to time. The updated version will be indicated by
      ...
      protecting your information. 15. HOW CAN YOU CONTACT US ABOUT THIS NOTICE?
      If you have questions or comments about this notice, you may contact our
      Data Protection Officer (DPO) by email at privacy@termly.io, by phone at
      (855) 234-5020, or by post to: Termly Inc. 8 The Grn Ste B Dover, DE 19901
      United States If you are located in the European Economic Area or the
      United Kingdom, the “data controller” of your personal information is
      Termly Inc. Termly Inc. has appointed DataRep to be its representative in
      the EEA and UK. You can contact them directly regarding the processing of
      your information by Termly Inc., by email at Termly@datarep.com, by
      visiting this link, or by post using the most convenient of the addresses
      listed here. 16. HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT
      FROM YOU? Based on the applicable laws of your country, you may have the
      ...
      contacting us using the information listed above or by filling out our
